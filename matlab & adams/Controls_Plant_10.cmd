...
!
data_element create variable  &
   variable_name = .MODEL_f.contact_1_torque_output  &
   adams_id = 29  &
   initial_condition = 0.0  &
   function = ""
!
...
marker create  &
   ...
   orientation = 1.5331964441E-008d, 0.0d, 0.0d
!
marker attributes  &
   marker_name = .MODEL_f.body.c3333  &
   visibility = off
...
marker create  &
   ...
   orientation = 90.0000052858d, 90.0000141303d, 355.9952526677d
!
marker attributes  &
   marker_name = .MODEL_f.mil.cm  &
   visibility = off
...
variable modify  &
   ...
   object_value =   &
      ...
      .MODEL_f.Vrel_output,  &
      .MODEL_f.Arel_output,  &
      .MODEL_f.contact_1_torque_output,  &
      .MODEL_f.f_prime_opt,  &
      .MODEL_f.N_opt,  &
      .MODEL_f.rubber_1_sensor_output,  &
      .MODEL_f.rubber_2_sensor_output,  &
...
data_element modify variable  &
   variable_name = .MODEL_f.contact_1_torque_output  &
   function = ".MODEL_f.CONTACT_1_torque"
!
data_element modify variable  &
   variable_name = .MODEL_f.f_prime_opt  &
   function = "-(.MODEL_f.CONTACT_1_force_x*COS(.MODEL_f.angle2*pi/180)-.MODEL_f.CONTACT_1_force_y*SIN(.MODEL_f.angle2*pi/180))"
!
data_element modify variable  &
   variable_name = .MODEL_f.N_opt  &
   function = "-(.MODEL_f.CONTACT_1_force_y*COS(.MODEL_f.angle2*pi/180)+.MODEL_f.CONTACT_1_force_x*SIN(.MODEL_f.angle2*pi/180))"
!
data_element modify variable  &
   variable_name = .MODEL_f.Xrel_output  &
...
measure modify function  &
   measure_name = .MODEL_f.thp  &
   function = "ATAN( ABS( .MODEL_f.body_Vx )/ABS( .MODEL_f.body_Vy ) )*180/pi"
!
measure modify function  &
   measure_name = .MODEL_f.angle2  &
   function = "RTOD*AZ(.MODEL_f.ground.MARKER_206,.MODEL_f.body.MARKER_203)-(AINT(AINT(RTOD*AZ(.MODEL_f.ground.MARKER_206,.MODEL_f.body.MARKER_203)/90)/2)+MOD(AINT(RTOD*AZ(.MODEL_f.ground.MARKER_206,.MODEL_f.body.MARKER_203)/90),2))*180"
!
measure modify function  &
   measure_name = .MODEL_f.Xrel  &
